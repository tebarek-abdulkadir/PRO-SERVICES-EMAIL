...
const COMPLAINT_BLOB_LOOKBACK_DAYS = 1200;
...
async function buildReport() {
  ...
  const text = [
    ...
    '2. Chat Analysis — Bot Coverage and By initiator.',
    '',
